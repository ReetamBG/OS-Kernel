...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
#[repr(C)] // to prevent rust compiler from messing up the ordering of the fields
struct ScreenChar {
    ascii_character: u8,
...
#[repr(transparent)] // to preserve exact structure in memory layout
struct Buffer {
    ...
    pub fn write_string(&mut self, s: &str) {
        for byte in s.bytes() {
            match byte {
                ...
                // any other non printable (out of ASCII range)
